...
public class SQLiteDialect extends Dialect {
	...
	public MultiTableBulkIdStrategy getDefaultMultiTableBulkIdStrategy() {
		...
		return new LocalTemporaryTableBulkIdStrategy(new IdTableSupportStandardImpl() {
			public String getCreateIdTableCommand() {
				return "createConfiguration temporary table";
			}
  ...
  */
	...
	private static class SQLiteUniqueDelegate extends DefaultUniqueDelegate {
		 ...
		 * constraints.
		 * Such as "createConfiguration table person( first_name varchar(255),last_name varchar(255),unique(first_name, last_name) )".
		 */
		@Override
